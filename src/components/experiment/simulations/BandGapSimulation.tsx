...
const BandGapSimulation = () => {
  ...
  }, [isRecording, material, temperature]);
      ...
      <div className="md:col-span-1 control-panel">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-2">
            <Button onClick={resetExperiment} variant="outline" disabled={isRecording}>Reset Experiment</Button>
            <Button onClick={exportData} disabled={dataPoints.length === 0 || isRecording}>Export Data</Button>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="border rounded-md p-3">
              ...
              <div className="text-2xl font-bold" style={{ 
                color: bandGap > 0 
                  ? Math.abs((bandGap / materials[material as keyof typeof materials].bandGap - 1) * 100) < 10 
                    ? '#00796b' 
                    : '#e65100' 
                  : '#9e9e9e' 
              }}>
          ...
          <div className="mt-6 border p-4 rounded-md bg-gray-50">
            ...
            <div className="relative h-40 bg-blue-50 border rounded-md flex items-center justify-center">
              ...
              <div className="relative w-2/3 h-24 bg-gray-300 rounded flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-red-500/20" style={{
                  opacity: (temperature - materials[material as keyof typeof materials].temperatureRange[0]) / 
