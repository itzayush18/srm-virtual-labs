...
const LightRay = ({
  ...
  return (
    <mesh ref={ref} position={startPoint} quaternion={quaternion}>
...
const OpticalFiber = ({
  ...
  return (
    <group>
      ...
      {/* Information text */}
      <Text position={[0, radius * 2, 0]} fontSize={0.15} color="#000" anchorX="center">
        n₁ = 1.45 (Core)
      </Text>

      <Text position={[0, radius * 2.5, 0]} fontSize={0.15} color="#000" anchorX="center">
        n₂ = 1.40 (Cladding)
      </Text>
    </group>
  );
...
const OpticalFiberScene: React.FC<{
  ...
  return (
    <Canvas shadows>
      ...
      <OpticalFiber length={5} radius={0.2} wavelength={wavelength} attenuation={attenuation} />
