      ...
      <div className="flex flex-col h-80 bg-white rounded-md border border-gray-200 overflow-hidden">
        <div className="flex-1 p-4 flex items-center justify-center">
          <CircuitVisualization 
            lightIntensity={intensityPercentage} 
        ...
        <div className="bg-gray-50 p-3 border-t border-gray-200 text-sm">
          <div className="flex justify-between">
            <div>Light Intensity: <span className="font-medium">{lightIntensity} lux</span></div>
            <div>LDR Resistance: <span className="font-medium">{resistance.toFixed(1)} kΩ</span></div>
          </div>
        </div>
      </div>
    </div>
