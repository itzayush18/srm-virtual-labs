        ...
        <div className="md:col-span-1 bg-white rounded-lg shadow-md p-4 border border-gray-200">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <Select value={structureType} onValueChange={value => setStructureType(value as 'sc' | 'bcc' | 'fcc' | 'diamond')}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              />
              <div className="text-xs text-gray-500">Cu Kα = 0.154 nm, Mo Kα = 0.071 nm</div>
            </div>
            ...
            <div className="bg-blue-50 p-3 rounded-md mb-4">
              ...
              <div className="text-xl font-bold text-blue-600">{calculatedLatticeParameter} nm</div>
              <div className="text-xs text-gray-500 mt-1">
                Error: {Math.abs(calculatedLatticeParameter - latticeConstant).toFixed(4)} nm (
                {Math.abs(
                  ((calculatedLatticeParameter - latticeConstant) / latticeConstant) * 100
                ).toFixed(2)}
                %)
              </div>
            </div>
